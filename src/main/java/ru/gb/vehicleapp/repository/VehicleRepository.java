...
public interface VehicleRepository extends JpaRepository<Vehicle, UUID>, JpaSpecificationExecutor<Vehicle> {
    ...
    List<Vehicle> findAll(@Param("brand") String brand, @Param("model") String model, @Param("category") String category,
                          @Param("regNumber") String regNumber, @Param("prodYear") Integer prodYear);
